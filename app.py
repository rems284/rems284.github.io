    ...
    [
        ...
        dbc.Nav(
            [
                ...
                dbc.NavLink("Exploración Datos", href="/datos", active="exact"),
                dbc.NavLink("Indicadores", href="/indicadores", active="exact"),
                dbc.NavLink("Dash interactivo", href="/dash", active="exact"),
...
def update_store_data( country,anio):
    ...
    return go.Figure(go.Indicator(mode = "number+delta",value = number,title = {'text': 'Total ofertas empleo'}))
...
def update_store_data( country):
    ...
    return go.Figure(go.Indicator(mode = "number+delta",value = number,title = {'text': '%'}))
